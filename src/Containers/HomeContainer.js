...
const HomeContainer = () => {
    ...
    return(
        <div>
            ...
            <HomeDiv/>
            <p className="about-text">Adventuro is a platform for adventurers to get their trips funded, while giving any added funds to the charity of their choice. Whether you have and adventure idea that you would like funded, or you would like to fund other adventurers along with their charities. Once an adventures minimum goal has been met, any fund beyond go to the charity of their choice! </p>
        </div>
    )
}
